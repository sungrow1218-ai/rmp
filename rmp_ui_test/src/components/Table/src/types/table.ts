...
import type { TableProps } from '@ht/sprite-ui';
import type { ColumnProps } from '@ht/sprite-ui/es/table/Column';
import type {
  Key,
  TableRowSelection as ITableRowSelection,
} from '@ht/sprite-ui/lib/table/interface';
...
export interface TableRowSelection<T = any>
  extends Omit<ITableRowSelection<any>, 'onChange'> {
  /**
...
export interface TableSetting {
  ...
  size?: boolean;
  setting?: boolean;
  // settingCache?: boolean; 不做缓存
  fullScreen?: boolean;
}

export interface TableFooterProps {
  summaryFunc?: Nullable<Fn>;
  summaryData?: Nullable<Recordable[]>;
...
type BasicTableExtraProps = TableHeaderProps &
  TableFooterProps &
  TableActionProps;

export interface BasicTableProps<T = any> extends BasicTableExtraProps {
  className?: string;
  style?: CSSProperties;
  // 点击行选中
   ...
   * @type object
   */
  components?: TableProps<Recordable>['components'];
   ...
   * @type Function
   */
  expandedRowRender?: (record?: ExpandedRowRenderRecord<T>) => ReactNode;

  /**
   * Customize row expand Icon.
   * @type Function | ReactNode
   */
  expandIcon?: Function | ReactNode;
  ...
  onFetchSuccess?: (params: { items: Recordable[]; total: number }) => void;
  onFetchError?: (err: any) => void;
  onSelectionChange?: (params: { keys: Key[]; rows: Recordable[] }) => void;
  register?: (table: TableActionType) => void;
  onRowClick?: (record: Recordable, index: number, e: any) => void;
  onRowDbClick?: (record: Recordable, index: number, e: any) => void;
  onRowContextMenu?: (record: Recordable, index: number, e: any) => void;
  onRowMouseEnter?: (record: Recordable, index: number, e: any) => void;
  onRowMouseLeave?: (record: Recordable, index: number, e: any) => void;
  onEditEnd?: (data: {
    record: any;
    index: number;
    key: string;
...
export interface BasicColumn extends ColumnProps<Recordable> {
  ...
  customHeaderRender?: (column: BasicColumn) => string | ReactNode;
  defaultHidden?: boolean;
  helpMessage?: string | string[] | ReactNode;
  format?: CellFormat;
  edit?: boolean;
  editRow?: boolean;
  editable?: boolean;
