...
import RuleRelation from '@/pages/ruleSetting/components/RuleRelation';
...
const ruleType = 'Z06101';

const EditFormZ060101: React.FC<Props> = ({
  mode,
  record,
  refetch,
  onClose,
...
export default EditFormZ060101;
