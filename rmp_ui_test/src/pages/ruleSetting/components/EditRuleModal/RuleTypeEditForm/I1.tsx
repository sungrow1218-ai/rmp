...
const EditFormZ01201: React.FC<Props> = ({
  ...
  const [ruleParamValues, setRuleParamValues] = useState({});

  // 监听控制方式
  const onRuleDimensionControlChange = (
    changedValues: Recordable,
    allValues: Recordable
  ) => {
    setRuleParamValues(allValues);
  };
  ...
  return (
    <>
      ...
      <RuleDimensionControl
        ...
        onValuesChange={onRuleDimensionControlChange}
      />
      <RuleSecurityControl
        mode={mode}
        ruleType={ruleType}
      ...
      <RuleCalculateParam
        ...
        ruleParamValues={ruleParamValues}
        sobInfo={sobInfo}
      />
