import { queryOptionInfo } from '@/services/securityInfo';
...
const OptionSelectSimple: React.FC<IProps> = ({
  value,
  onChange,
  marketId,
  style = { width: '240px' },
  ...
  const onSearch = async (searchValue: string) => {
    try {
      ...
      const result = await queryOptionInfo(params);
      if (result.errorId !== 0) {
...
export default OptionSelectSimple;
