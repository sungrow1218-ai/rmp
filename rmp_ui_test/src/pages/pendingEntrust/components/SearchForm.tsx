...
import { ENTRUST_DIRECTION, PENDING_ENTRUST_STATUS } from '@/utils/dictEntrust';
...
const SearchForm: React.FC<Props> = ({
  ...
  return (
    <div className={styles.search}>
      <CardTitle title={'挂单查询'} style={{ paddingBottom: '16px' }} />
      <Form
        initialValues={{
          primaryFlag: 0,
          entrustType: ['0'],
        ...
        <Row>
          ...
          <Col span={6}>
            <FormItem label="委托状态" name="entrustStatus">
              <MultipleSelect options={transformDict(PENDING_ENTRUST_STATUS)} />
            </FormItem>
          </Col>
          <Col span={6}>
