import { queryFutureInfo } from '@/services/securityInfo';
...
const FutureSelectSimple: React.FC<IProps> = ({
  value,
  onChange,
  marketId,
  style = { width: '240px' },
  ...
  const onSearch = async (searchValue: string) => {
    try {
      ...
      const result = await queryFutureInfo(params);
      if (result.errorId !== 0) {
...
export default FutureSelectSimple;
