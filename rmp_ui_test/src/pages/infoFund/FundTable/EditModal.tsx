...
export interface IAction {
  open: (mode: FORM_MODE, defaultValue?: FundItem) => void;
}
...
const EditModal = forwardRef<IAction, IProps>(({ onRefresh }, ref) => {
    ...
    open: (inputMode, defaultValue) => {
      ...
      if (inputMode === FORM_MODE.EDIT && defaultValue) {
        const basicData: Recordable = {
          ...
          fundInvestClass: defaultValue.fundInvestClass,
          fundIssueType: defaultValue.fundIssueType,
          fundRiskProfitType: defaultValue.fundRiskProfitType,
          fundInvestNature: defaultValue.fundInvestNature,
        ...
        const tradeData: Recordable = {
          ...
          previousNav: defaultValue.previousNav,
          etfReportUnit: defaultValue.etfReportUnit,
          estimateCashBalance: defaultValue.estimateCashBalance,
          etfPreBasisNav: defaultValue.etfPreBasisNav,
          tradeUnitType: defaultValue.tradeUnitType,
          tradeUnitAmount: defaultValue.tradeUnitAmount,
          totalAmount: defaultValue.totalAmount,
        };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const params: DeepPartial<ReqAlterInvestFundInfo> = {
        ...
        fundInvestClass: basicData.fundInvestClass,
        fundIssueType: basicData.fundIssueType,
        fundRiskProfitType: basicData.fundRiskProfitType,
        fundInvestNature: basicData.fundInvestNature,
        ...
        previousNav: tradeData.previousNav,
        etfReportUnit: tradeData.etfReportUnit,
        estimateCashBalance: tradeData.estimateCashBalance,
        etfPreBasisNav: tradeData.etfPreBasisNav,
        tradeUnitType: tradeData.tradeUnitType,
        tradeUnitAmount: tradeData.tradeUnitAmount,
      };
      const res = await alterInvestFundInfo(params);
      if (res.errorId !== 0) {
  ...
  return (
    <Modal
      title={mode === FORM_MODE.ADD ? '新增基金信息' : '编辑基金信息'}
      open={open}
