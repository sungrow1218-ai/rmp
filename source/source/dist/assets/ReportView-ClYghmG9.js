import { r as reactExports, I as Icon, l as useData, m as dayjs, j as jsxRuntimeExports } from "./index-CUErrqgd.js";
...
import { R as RefIcon$2 } from "./SyncOutlined-pDb5-K5A.js";
...
const EnvironmentFilled = (props, ref) => /* @__PURE__ */ reactExports.createElement(Icon, _extends({}, props, {
  ref,
  icon: EnvironmentFilled$1
}));
const RefIcon = /* @__PURE__ */ reactExports.forwardRef(EnvironmentFilled);
...
const ReportView = () => {
  ...
  const [exceedFilter, setExceedFilter] = reactExports.useState("all");
  const [queryDate, setQueryDate] = reactExports.useState(dayjs());
  const [selectedRowKeys, setSelectedRowKeys] = reactExports.useState([]);
  const [loading, setLoading] = reactExports.useState(false);
  const [lastUpdateTime, setLastUpdateTime] = reactExports.useState(dayjs().format("HH:mm:ss"));
  ...
  reactExports.useEffect(() => {
    ...
    if (isToday) {
      intervalId = setInterval(() => {
        ...
        staticMethods.success("数据已自动刷新", 1);
      }, 6e4);
    }
    return () => {
  ...
  const handleSearch = () => {
    ...
    setTimeout(() => {
      ...
      setLastUpdateTime(dayjs().format("HH:mm:ss"));
      setLoading(false);
      staticMethods.success(`已加载 ${queryDate.format("YYYY-MM-DD")} 的数据`);
    }, 500);
  };
  const handleOpenModal = () => {
    if (selectedRowKeys.length === 0) {
      staticMethods.warning("请先选择要修改额度的证券");
      return;
    }
  ...
  const handleExport = () => {
    ...
    const rows = filteredData.map((item) => [
      item.symbol,
      item.name,
      (item.totalShares || 0) / 1e4,
      (item.totalHoldings || 0) / 1e4,
      `${(item.holdingsRatioExclCB || 0).toFixed(2)}%`,
      `${(item.holdingsRatioInclCB || 0).toFixed(2)}%`,
      `${(item.quotaAllocation || 0).toFixed(2)}%`,
      item.parentInitialHoldingsExclCB || 0,
      item.parentMaxIntradayHoldingsExclCB || 0,
      item.parentCurrentHoldingsExclCB || 0,
      `${(item.parentHoldingsRatioExclCB || 0).toFixed(2)}%`,
      item.parentInitialHoldingsInclCB || 0,
      item.parentMaxIntradayHoldingsInclCB || 0,
      item.parentCurrentHoldingsInclCB || 0,
      `${(item.parentHoldingsRatioInclCB || 0).toFixed(2)}%`,
      `${(item.parentQuotaAllocation || 0).toFixed(2)}%`,
      item.hkInitialHoldingsExclCB || 0,
      item.hkMaxIntradayHoldingsExclCB || 0,
      item.hkCurrentHoldingsExclCB || 0,
      `${(item.hkHoldingsRatioExclCB || 0).toFixed(2)}%`,
      item.hkInitialHoldingsInclCB || 0,
      item.hkMaxIntradayHoldingsInclCB || 0,
      item.hkCurrentHoldingsInclCB || 0,
      `${(item.hkHoldingsRatioInclCB || 0).toFixed(2)}%`,
      `${(item.hkQuotaAllocation || 0).toFixed(2)}%`,
      item.connectInitialHoldingsExclCB || 0,
      item.connectMaxIntradayHoldingsExclCB || 0,
      item.connectCurrentHoldingsExclCB || 0,
      `${(item.connectHoldingsRatioExclCB || 0).toFixed(2)}%`,
      item.connectInitialHoldingsInclCB || 0,
      item.connectMaxIntradayHoldingsInclCB || 0,
      item.connectCurrentHoldingsInclCB || 0,
      `${(item.connectHoldingsRatioInclCB || 0).toFixed(2)}%`,
    ...
    worksheet["!merges"] = [
      ...
      // 不含债转股
      { s: { r: 1, c: 20 }, e: { r: 1, c: 23 } },
      // 含债转股
      { s: { r: 1, c: 24 }, e: { r: 2, c: 24 } },
      // 额度配置
      { s: { r: 0, c: 25 }, e: { r: 0, c: 33 } },
      // 陆股通
      { s: { r: 1, c: 25 }, e: { r: 1, c: 28 } },
      // 不含债转股
      { s: { r: 1, c: 29 }, e: { r: 1, c: 32 } },
      // 含债转股
      { s: { r: 1, c: 33 }, e: { r: 2, c: 33 } }
      // 额度配置
    ];
    const workbook = utils.book_new();
    utils.book_append_sheet(workbook, worksheet, "集中度报表");
    writeFileSync(workbook, `股票集中度监控大盘_${queryDate.format("YYYYMMDD")}.xlsx`);
    staticMethods.success("导出成功");
  };
  ...
  const renderHoldings = (val, colorClass = "font-medium text-gray-700", unit = "") => {
    const safeVal = val || 0;
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: colorClass, children: safeVal.toLocaleString(void 0, { maximumFractionDigits: 2 }) }),
      unit && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-gray-400 leading-none mt-0.5", children: unit })
    ] });
  };
  const renderRatio = (val, colorClass = "font-medium text-gray-700") => {
    const safeVal = val || 0;
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: colorClass, children: [
      safeVal.toFixed(2),
      "%"
    ] }) });
  };
  const renderExceed = (val, limit, defaultClass = "font-medium text-gray-700") => {
    const safeVal = val || 0;
    const safeLimit = limit || 0;
    const isExceed = safeVal > safeLimit;
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `${isExceed ? "text-red-500 font-bold bg-red-50 px-1 rounded" : defaultClass}`, children: [
      safeVal.toFixed(2),
      "%"
    ] }) });
  };
  const columns = [
    { title: "证券代码", dataIndex: "symbol", width: 80, render: (text) => /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "text-blue-600 font-medium", children: text }), fixed: "left", align: "center" },
    { title: "证券名称", dataIndex: "name", width: 90, fixed: "left", align: "center", render: (text) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-gray-800", children: text }) },
    { title: "总股本(万股)", dataIndex: "totalShares", width: 100, align: "right", render: (val) => renderHoldings((val || 0) / 1e4) },
    { title: "汇总持仓(万股)", dataIndex: "totalHoldings", width: 110, align: "right", render: (val) => renderHoldings((val || 0) / 1e4, "text-blue-600 font-semibold") },
    ...
    { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center justify-center gap-1", children: [
      "总额度 ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(RefIcon, { className: "text-[#c27b57]" })
    ] }), dataIndex: "quotaAllocation", width: 90, align: "center", render: (val) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[#c27b57] font-bold bg-[#fff7e6] px-2 py-0.5 rounded border border-[#ffd8bf]", children: [
      (val || 0).toFixed(2),
      "%"
    ] }) },
    // 母公司
    {
      ...
      children: [
        ...
        { title: "额度", dataIndex: "parentQuotaAllocation", width: 70, align: "center", className: parentClass, render: (val) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-green-700 font-bold", children: [
          (val || 0).toFixed(2),
          "%"
        ] }) }
      ]
    ...
    // 香港金控
    {
      ...
      children: [
        ...
        { title: "额度", dataIndex: "hkQuotaAllocation", width: 70, align: "center", className: hkClass, render: (val) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-purple-700 font-bold", children: [
          (val || 0).toFixed(2),
          "%"
        ] }) }
      ]
    ...
    // 陆股通
    {
      ...
      children: [
        ...
        { title: "额度", dataIndex: "connectQuotaAllocation", width: 70, align: "center", className: connectClass, render: (val) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-orange-700 font-bold", children: [
          (val || 0).toFixed(2),
          "%"
        ] }) }
      ]
  ...
  const modalColumns = [
    {
      ...
      children: [
        ...
        { title: "总额度", dataIndex: "quotaAllocation", width: 80, render: (val) => `${(val || 0).toFixed(2)}%` },
        { title: "母公司", dataIndex: "parentQuotaAllocation", width: 80, render: (val) => `${(val || 0).toFixed(2)}%` },
        { title: "香港金控", dataIndex: "hkQuotaAllocation", width: 80, render: (val) => `${(val || 0).toFixed(2)}%` },
        { title: "陆股通", dataIndex: "connectQuotaAllocation", width: 80, render: (val) => `${(val || 0).toFixed(2)}%` }
      ]
    },
    {
      title: "修改后信息",
      children: [
        {
          ...
          dataIndex: "symbol",
          width: 90,
          render: (text, _, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-blue-600 font-medium", children: text }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Form.Item, { name: ["items", index, "symbol"], hidden: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, {}) })
          ] })
        },
        {
          title: "总额度",
          width: 110,
          render: (_, __, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Form.Item, { name: ["items", index, "quotaAllocation"], rules: [{ required: true, message: "必填" }], style: { margin: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(TypedInputNumber, { min: 0, max: 100, step: 0.1, addonAfter: "%", size: "small", style: { width: "100%" } }) })
        },
        {
          title: "母公司",
          width: 110,
          render: (_, __, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Form.Item, { name: ["items", index, "parentQuotaAllocation"], rules: [{ required: true, message: "必填" }], style: { margin: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(TypedInputNumber, { min: 0, max: 100, step: 0.1, addonAfter: "%", size: "small", style: { width: "100%" } }) })
        },
        {
          title: "香港金控",
          width: 110,
          render: (_, __, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Form.Item, { name: ["items", index, "hkQuotaAllocation"], rules: [{ required: true, message: "必填" }], style: { margin: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(TypedInputNumber, { min: 0, max: 100, step: 0.1, addonAfter: "%", size: "small", style: { width: "100%" } }) })
        },
        {
          title: "陆股通",
          width: 110,
          render: (_, __, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Form.Item, { name: ["items", index, "connectQuotaAllocation"], rules: [{ required: true, message: "必填" }], style: { margin: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(TypedInputNumber, { min: 0, max: 100, step: 0.1, addonAfter: "%", size: "small", style: { width: "100%" } }) })
        }
      ]
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col absolute inset-0 bg-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 pt-6 pb-4 border-b border-gray-100 shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { level: 4, style: { margin: 0, color: "#1f2937" }, children: "股票集中度监控大盘" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(RefIcon$1, { className: "text-gray-400 text-base cursor-pointer hover:text-[#c27b57] transition-colors" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CompoundedSpace, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-500 flex items-center gap-1.5 mr-4 bg-gray-50 px-3 py-1.5 rounded-full border border-gray-200", children: queryDate.isSame(dayjs(), "day") ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(RefIcon$2, { spin: true, className: "text-[#c27b57]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "最后更新：",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-gray-700", children: lastUpdateTime })
            ] })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400", children: "历史数据（不刷新）" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "bg-white text-[#c27b57] border-[#c27b57] hover:!bg-[#fff7e6] hover:!text-[#a66544] hover:!border-[#a66544]", onClick: handleExport, children: "导出数据" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "primary", className: "bg-[#c27b57] hover:!bg-[#a66544] border-none shadow-sm", onClick: handleOpenModal, children: "批量修改额度" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6 bg-gray-50 p-4 rounded-lg border border-gray-100", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600 text-sm font-medium", children: "查询日期" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600 text-sm font-medium", children: "证券代码" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              placeholder: "输入代码或名称",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600 text-sm font-medium", children: "额度状态" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Select,
            {
              value: exceedFilter,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pt-2 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultActiveKey: "A", className: "custom-tabs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tabs.TabPane, { tab: "A+H股" }, "AH"),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tabs.TabPane, { tab: "A股" }, "A"),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tabs.TabPane, { tab: "H股" }, "H")
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-hidden px-6 pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ForwardTable,
      {
        rowSelection: {
          selectedRowKeys,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Modal,
      {
        title: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold text-gray-800", children: "批量修改额度配置" }),
        open: isModalVisible,
        onOk: handleModalOk,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 mb-2 text-gray-500", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(RefIcon$1, { className: "mr-2 text-[#c27b57]" }),
