...
const InfoCircleOutlined = (props, ref) => /* @__PURE__ */ reactExports.createElement(Icon, _extends({}, props, {
  ref,
  icon: InfoCircleOutlined$1
}));
const RefIcon = /* @__PURE__ */ reactExports.forwardRef(InfoCircleOutlined);
export {
  RefIcon as R
};
