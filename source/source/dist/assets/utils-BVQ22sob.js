import { b as unit, a as resetComponent, r as reactExports, d as ConfigContext, e as classNames, R as React, g as devUseWarning, h as useToken, i as globalConfig$1, C as ConfigProvider, k as commonjsGlobal } from "./index-CUErrqgd.js";
import { r as render } from "./render-uL5zGIDv.js";
import { N as Notify, u as useNotification$1, a as NotificationProvider, A as AppConfigContext } from "./context-CN2GVsG0.js";
import { R as RefIcon$1, a as RefIcon$4 } from "./ExclamationCircleFilled-CXyczA-G.js";
import { g as genStyleHooks, m as merge, a as genSubStyleComponent, R as RefIcon$2 } from "./asyncToGenerator-Bn7YJjF8.js";
import { K as Keyframe, C as CONTAINER_MAX_OFFSET, u as useCSSVarCls, R as RefIcon } from "./useZIndex-BReSjmbj.js";
...
const useStyle = genStyleHooks("Notification", (token) => {
...
const Holder = /* @__PURE__ */ React.forwardRef((props, ref) => {
  ...
  React.useImperativeHandle(ref, () => Object.assign(Object.assign({}, api2), {
    prefixCls,
    notification: notification2
  }));
  return holder;
  ...
  const wrapAPI = React.useMemo(() => {
    const open2 = (config) => {
      ...
      const {
        ...
        role = "alert",
        closeIcon
      } = config, restConfig = __rest(config, ["message", "description", "icon", "type", "btn", "className", "style", "role", "closeIcon"]);
...
const GlobalHolder = /* @__PURE__ */ React.forwardRef((props, ref) => {
  ...
  const [api2, holder] = useInternalNotification(Object.assign(Object.assign(Object.assign({}, notificationConfig), {
    prefixCls
  ...
  React.useImperativeHandle(ref, () => {
    ...
    Object.keys(instance).forEach((method) => {
      instance[method] = function() {
        sync();
        return api2[method].apply(api2, arguments);
      };
    });
    return {
      instance,
...
const COOKIE_TOKEN_KEY = "risk-manage-token";
const codeMessage = {
  200: "服务器成功返回请求的数据。",
  201: "新建或修改数据成功。",
...
var CustomCode = /* @__PURE__ */ ((CustomCode2) => {
  CustomCode2[CustomCode2["NO_AUTH"] = 3e4] = "NO_AUTH";
  CustomCode2[CustomCode2["TOKEN_EXPIRED"] = 90005] = "TOKEN_EXPIRED";
  return CustomCode2;
})(CustomCode || {});
const globalConfig = {
  prefix: "/rmp",
...
async function request(url, config = {}) {
  ...
  if (data !== void 0 && !fetchConfig.body) {
  ...
  console.log("🔍 请求信息:", {
    ...
    data: config.data || (config.body ? JSON.parse(config.body) : void 0),
  ...
  try {
    ...
    console.log("🔍 响应数据:", data2);
    console.log("🔍 响应字段:", {
      hasErrorId: "errorId" in data2,
      errorId: data2.errorId,
      hasCode: "code" in data2,
      code: data2.code,
      hasErrorMessage: "errorMessage" in data2,
      errorMessage: data2.errorMessage,
      hasMessage: "message" in data2,
      message: data2.message
    });
    if (data2.code === CustomCode.TOKEN_EXPIRED) {
...
async function parseRequest(promise) {
  try {
    const response = await promise;
    if ("errorId" in response) {
      const { errorId, errorMessage, data, ...rest } = response;
      return {
        ...rest,
...
async function parseRequestByPage(promise) {
  try {
    const response = await promise;
    if ("errorId" in response) {
      const { errorId, errorMessage, data, ...rest } = response;
...
async function getCurrentUserRoles(params) {
...
const setAccessToken = (token) => {
  return api.set(COOKIE_TOKEN_KEY, token);
};
const getAccessToken = () => {
  return api.get(COOKIE_TOKEN_KEY);
};
const removeAccessToken = () => {
  return api.remove(COOKIE_TOKEN_KEY);
};
export {
  removeAccessToken as a,
  getCurrentUserRoles as b,
  globalConfig as c,
  redirectToEntry as d,
  extendOptions as e,
  logout as f,
  getAccessToken as g,
  isEip as i,
  lodashExports as l,
  redirectToLogin as r,
  setAccessToken as s,
  userLogin as u,
  validateToken as v
};
