...
const DeleteOutlined = (props, ref) => /* @__PURE__ */ reactExports.createElement(Icon, _extends$1({}, props, {
  ref,
  icon: DeleteOutlined$1
}));
const RefIcon$1 = /* @__PURE__ */ reactExports.forwardRef(DeleteOutlined);
function _extends() {
