...
const CheckCircleOutlined = (props, ref) => /* @__PURE__ */ reactExports.createElement(Icon, _extends({}, props, {
  ref,
  icon: CheckCircleOutlined$1
}));
const RefIcon = /* @__PURE__ */ reactExports.forwardRef(CheckCircleOutlined);
export {
  RefIcon as R
};
