import { r as reactExports, s as _extends, d as ConfigContext, e as classNames, ag as supportNodeRef, a1 as useComposeRef, b as unit, a9 as genFocusOutline, a0 as textEllipsis, T as TinyColor, $ as clearFix, a as resetComponent, A as resetIcon, a5 as useEvent, t as genFocusStyle, h as useToken, g as devUseWarning } from "./index-CUErrqgd.js";
import { R as RefIcon$2 } from "./RightOutlined-BAFHU4sg.js";
import { a as Divider, M as MenuItem$1, u as useFullPath, S as SubMenu$1, b as MenuItemGroup, E as ExportMenu, R as RefIcon$3, D as Dropdown$2 } from "./EllipsisOutlined-BuwqaHFz.js";
import { T as Tooltip, i as initZoomMotion, e as initCollapseMotion, a as getArrowOffsetToken, g as getArrowToken, b as getArrowStyle, u as useMergedState, p as getPlacements } from "./index-BKheaG9T.js";
import { o as omit, c as cloneElement } from "./reactNode-TfIvHo6t.js";
import { b as useZIndex, u as useCSSVarCls, z as zIndexContext } from "./useZIndex-BReSjmbj.js";
...
import { t as toArray, N as NoCompactStyle, a as useCompactItemContext } from "./compact-item-T75FitAV.js";
import { i as initSlideMotion, a as slideDownOut, s as slideUpOut, c as slideDownIn, b as slideUpIn } from "./Overflow-DO7wolsL.js";
...
const Sider = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  const {
    ...
    onCollapse,
    onBreakpoint
  } = props, otherProps = __rest$5(props, ["prefixCls", "className", "trigger", "children", "defaultCollapsed", "theme", "style", "collapsible", "reverseArrow", "width", "collapsedWidth", "zeroWidthTriggerStyle", "breakpoint", "onCollapse", "onBreakpoint"]);
  const {
    siderHook
  ...
  const renderSider = () => {
    ...
    }, trigger || /* @__PURE__ */ reactExports.createElement(RefIcon$1, null)) : null;
    const iconObj = {
  ...
  return (list || []).map((opt, index) => {
    if (opt && typeof opt === "object") {
      const _a = opt, {
        ...
        key,
        type
      } = _a, restProps = __rest$3(_a, ["label", "children", "key", "type"]);
...
const InternalMenu = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  ...
  } = props, restProps = __rest$1(props, ["prefixCls", "className", "style", "theme", "expandIcon", "_internalDisableMenuItemTitleTooltip", "inlineCollapsed", "siderCollapsed", "items", "children", "rootClassName", "mode", "selectable", "onClick", "overflowedIndicatorPopupClassName"]);
...
const PurePanel = genPurePanel(Dropdown$1, "dropdown", (prefixCls) => prefixCls, postPureProps);
...
const DropdownButton = (props) => {
  ...
  const {
    ...
    getPopupContainer,
    href,
    icon = /* @__PURE__ */ reactExports.createElement(RefIcon$3, null),
    title,
